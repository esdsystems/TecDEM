function M = flowdir_single(DEM,varargin)

% this file has been slightly modified to meet the i/o requirments of
% TecDEM.
%
...
add_histroy({'Flow neighbours are identified.'})
...
add_histroy({'Flow routed on flat areas using D8'})
